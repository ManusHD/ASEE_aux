...
isDisplayed()))
        ...
        val textView = onView(
allOf(withId(R.id.temperature_view), withText("12º C"),
withParent(withParent(withId(android.R.id.content))),
isDisplayed()))
        textView.check(matches(isDisplayed()))
        
        val textView2 = onView(
allOf(withId(R.id.descripcion_view), withText("Despejado"),
withParent(withParent(withId(android.R.id.content))),
isDisplayed()))
        textView2.check(matches(isDisplayed()))
        
        val recyclerView = onView(
allOf(withId(R.id.rvProximasHoras),
withParent(withParent(withId(R.id.pronostico_nav_host_fragment))),
isDisplayed()))
...
allOf(withId(R.id.rvProximosDias),
withParent(withParent(withId(R.id.pronostico_nav_host_fragment))),
isDisplayed()))
